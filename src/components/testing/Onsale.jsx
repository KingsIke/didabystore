...
const Card = () => {
  return (
    <>
    <div  className="bg-[#fec634] ml-2 container  flex flex-col h-[385px] w-[1035px]">
   ...
   <div className="flex justify-between  mb-2 absolute top-0 right-0 ">

   <span>
   <GiSelfLove class="text-sm text-yellow-400" />
   </span>
   </div>
   ...
   <p class="w-fit absolute bottom-2.5 left-20 rounded-full whitespace-nowrap bg-red-400 text-white text-xs font-medium py-0 px-3 self-center ">5 left</p>
