        ...
        <div className='w-100% h-[327px] bg-black border-solid border-2 border-orange-400'>
            <div className=" mr-4 ml-5 pt-10 ">
                <div className="container mx-auto  ">
                    ...
                    <div className='text-white mr-[25px] whitespace-nowrap'>
                        <h3 className=' '>Phone & Tablet</h3>
                        <h3 className='pt-2 '>Electronics</h3>
                        <h3 className='pt-2 '>Appliances</h3>
                    </div>
                    <div className='text-white  '>
                        <p className='whitespace-nowrap text-zinc-100 text-[14px]  tracking-normal'>Get update on our latest deals and discount by subscribing to our newsletter</p>
                        <div className='relative mt-5'>
                            ...
                            />
                            <button
                                className="absolute right-0 top-0 h-[46px] bg-lime-500 rounded-[10px] px-4  text-zinc-950 text-lg font-semibold"
